...
def set_num_devices(number_devices, proportion_always_on, proportion_periodic_reboot, reboot_length, reboot_period,
    ...
    init_string = "BM=Botmaster();CNC=CnC_Server();RPT=Report_Server();LDR=Loader();BOT_DF=Bot_Default(0,110);"#"CNC=CnC();QUEUE=CnC_queue();BOT_DF = Bot_Default(0,110);"
    ...
    init_string += "system CNC, BM, RPT, LDR, BOT_DF,"#"system CNC, QUEUE, BOT_DF,"
